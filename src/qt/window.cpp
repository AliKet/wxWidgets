        ...
        const wxSize & size, long style, const wxString &name )
{
    ...
    if ( GetHandle() == nullptr )
    {
        ...
        // Do not pass 'size_' to CreateBase() below, as it will be taken as the minimum size
        // of the control, which is not the intention here.
        size_.SetDefaults(wxSize(20, 20));
    }
